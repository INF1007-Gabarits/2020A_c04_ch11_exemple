...
class Fight:
    ...
    def first_fight(self):
        ...
        elif self.fighter1.title < self.fighter2.title:
    ...
    def round_phase(self, attacker, defender):
    ...
    def weapon_survivership(self, attacker, defender):
    ...
    def start(self):
        ...
        attacker, defender = self.first_fight()
        round_number = 1
        while self.fighter1.health > 0 or self.fighter2.health > 0:
            print(f"Round {round_number}")
            self.round_phase(attacker, defender)
            temp = attacker
            attacker = defender
            defender = temp
            round_number += 1
